...
function Starlight:CreateWindow(WindowSettings)
	...
	function Starlight.Window:CreateHomeTab(TabSettings)
		...
		task.spawn(function()
			connections.__homeTabTime = RunService.RenderStepped:Connect(function()
				...
				elseif hour >= 19 and hour <= 23 then
					...
					greetingString = "You should be asleep rn."
				end
				Tab.Instances.Page.playerUser.Text = `{greetingString}`
		...
		Tab.Instances.Page.Holder.Left.Server.Subheader.Text = MarketplaceService:GetProductInfo(game.PlaceId).Name
